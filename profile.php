...
<h3 style="color:#888;font-size:14px;margin:0 0 16px;text-transform:uppercase;letter-spacing:0.5px"><?= __('your_posts') ?></h3>

<?php if (empty($user_posts)): ?>
<p style="color:#555;font-size:14px"><?= __('no_posts_yet') ?></p>
<?php else: ?>
